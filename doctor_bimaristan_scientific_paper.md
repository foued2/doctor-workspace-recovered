...
**Current status:** R-coverage is unidentifiable for LC79/LC743 external under current sampling
(class-based solvers have higher CE, reducing B-observable sample; absence of observation does
not imply structural absence in B-space). R-coverage is partially evidenced for LC322 external
...
| External, LC322   | pass | pass | partially evidenced | VALID | independent provenance, n=38, mixed R-classes |
| External, LC79    | pass | EVC-FAILING | unidentifiable | EVC-FAILING | n=1, class-based CE bias |
| External, LC743   | pass | EVC-FAILING | unidentifiable | EVC-FAILING | n=1, class-based CE bias |
...
are not met (insufficient B-equivalence classes). R-coverage unidentifiable means the sampling
assumption cannot be verified from the observed sample; absence of evidence is not evidence of
absence. VALID means GDC and EVC hold; R-coverage is assumed but not proven.
