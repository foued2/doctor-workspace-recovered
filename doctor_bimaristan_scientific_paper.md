...
DCG is evaluated on generation provenance and behavioral equivalence properties, before computing
P(D). GDC is determined by provenance disjointness (S ∩ CSSE_generators = ∅). EVC is determined
by B-domain properties (B-equivalence completeness, unified evaluator, endogenous failure,
sufficient B-domain sample).

| (Source, Problem) | GDC | EVC (B-domain) | DCG | Notes |
|-------------------|-----|----------------|-----|-------|
| CSSE v2, LC322    | GDC-FAILING | pass | GDC-FAILING | generated by CSSE mutation engine |
| CSSE v2, LC3946   | GDC-FAILING | pass | GDC-FAILING | generated by CSSE mutation engine |
| CSSE v2, LC79     | GDC-FAILING | pass | GDC-FAILING | generated by CSSE mutation engine |
| CSSE v2, LC743    | GDC-FAILING | pass | GDC-FAILING | generated by CSSE mutation engine |
| External, LC322   | pass | pass | VALID | independent provenance, n=38 ≥ 30 B-classes |
| External, LC79    | pass | EVC-FAILING | EVC-FAILING | independent provenance, n=1 < 30 B-classes |
| External, LC743   | pass | EVC-FAILING | EVC-FAILING | independent provenance, n=1 < 30 B-classes |
| LC3946, hand-coded| pass | pass | VALID | hand-coded, not CSSE-generated; structurally excluded |
