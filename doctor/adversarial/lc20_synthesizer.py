...
from doctor.adversarial.lc20_synthesizer import (
    evaluate_lc20_candidates,
    generator_counts,
    synthesize_lc20_inputs,
)


def main() -> None:
    batch = synthesize_lc20_inputs()
    evaluations = evaluate_lc20_candidates(batch)

    print("LC20 Bimaristan native run")
