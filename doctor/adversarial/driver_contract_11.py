"""LC137 driver for the generalized ingestion gate (Single Number II)."""
...
def lc137_nums_reordering_perturbations(
...
def lc137_ingestion_gate(
    ...
    return ingestion_gate(
        ...
        perturbation_strategy=lc137_nums_reordering_perturbations,
        comparator=get_driver_contract("LC137").comparator,
