"""Create solver files for LC322 second population."""
import sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent.parent
solvers_dir = ROOT / "experiments" / "frozen_taxonomy_lc322_v2" / "solvers"
solvers_dir.mkdir(parents=True, exist_ok=True)

# Create solver files
for i in range(1, 31):
    solver_id = f"solver_{i:03d}"
    content = f'''"""LC322 v2 solver {solver_id}."""
from doctor.adversarial.lc322_candidates_v2 import {solver_id} as _impl
