# runners/run_c4_decisions_lc45.py
# Phase C-4: Genuine Structured Policy — LC45 runner
#
# Re-runs B1 and C_genuine on the LC45 population with per-solver decision
# logging. Verifies aggregate consistency of B1 against stored (WA, WR) from
# data/midweather_fingerprint_lc45.json. Computes D, A, and utility gap
...
OUTPUT_PATH            = ROOT / "data" / "c4_decisions_lc45.json"
...
def main() -> None:
    ...
    write_gated_artifact(OUTPUT_PATH, output, "A10", "ARTIFACT_WRITE", ("C-4",))
