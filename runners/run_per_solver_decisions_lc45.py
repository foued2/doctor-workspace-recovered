# runners/run_per_solver_decisions_lc45.py
# Phase C-3a: Per-Solver Decision Persistence — LC45 runner
#
# Re-runs the 8 estimators on the LC45 population with per-solver decision
# logging. Verifies aggregate consistency with stored (WA, WR) from
# data/midweather_fingerprint_lc45.json. Writes per-solver decisions to
# data/midweather_fingerprint_lc45_per_solver.json.
#
...
OUTPUT_PATH            = ROOT / "data" / "midweather_fingerprint_lc45_per_solver.json"
...
def main() -> None:
    ...
    write_gated_artifact(OUTPUT_PATH, output, "A21", "ARTIFACT_WRITE", ("FP",))
